...
namespace WMIWrappers.Raw {
    ...
    public class Msvm_PlannedComputerSystem : WMIWrapper {
        
        public Msvm_PlannedComputerSystem(System.Management.ManagementObject instance) : 
                base(instance) {
        }
        
        public virtual ushort[] AssignedNumaNodeList {
            get {
                return ((ushort[])(Instance["AssignedNumaNodeList"]));
            }
            set {
                Instance["AssignedNumaNodeList"] = value;
            }
        }
